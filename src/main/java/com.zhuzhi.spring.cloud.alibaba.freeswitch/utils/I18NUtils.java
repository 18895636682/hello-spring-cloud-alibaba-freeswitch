 ...
 */
//Changed by chenhb, 读取 i18n_xx.properties 文件
public class I18NUtils
{
     ...
     */
    private static ThreadLocal<Locale> threadContentLocale;
    private static ThreadLocal<Locale> threadContentLocaleLang;
    
    /**
     * List of registered bundles
     */
    private static Set<String> resouceBundleBaseNames;
    
    /**
     * Map of loaded bundles by Locale
     */
    private static Map<Locale, Set<String>> loadedResourceBundles;
    
    /**
     * Map of cached messaged by Locale
     */
    private static Map<Locale, Map<String, String>> cachedMessages;
    ...
    //Changed by chenhb
  	static{
  		threadLocale = new ThreadLocal<Locale>();
  		threadContentLocale = new ThreadLocal<Locale>();
  		threadContentLocaleLang = new ThreadLocal<Locale>();
  		resouceBundleBaseNames = new HashSet<String>();
  		loadedResourceBundles = new HashMap<Locale, Set<String>>();
  		cachedMessages = new HashMap<Locale, Map<String, String>>();
  		
  		I18NUtils.registerResourceBundle("i18n");
  	}
